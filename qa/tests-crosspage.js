...
/*
    test('requesting a group rate quote from the hood river tour page should populate the referred field', function(done){
        var referrer = 'http://localhost:3000/tours/hood-river';
        browser.visit(referrer, function () {
           browser.clickLink('.requestGroupRate', function () {
               assert(browser.field('referrer').value === 'http://localhost:3000/tours/hood-river');
               done();
           });
        });
    });
